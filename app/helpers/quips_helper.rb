# taken from https://raw.github.com/amerine/in_place_editing/master/lib/in_place_editing/helper_methods.rb
module QuipsHelper
  ...
  def in_place_editor_field(instance, object, method, tag_options = {}, in_place_editor_options = {})
    instance_tag = ::ActionView::Helpers::InstanceTag.new(object, method, self, instance)
